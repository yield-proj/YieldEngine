...
public class CloseableTabbedPane extends JTabbedPane {
    ...
    public CloseableTabbedPane(boolean closeAfterEmpty) {
        this.closeAfterEmpty = closeAfterEmpty;
    }

    public CloseableTabbedPane(boolean closeAfterEmpty, TabClosingListener aTabClosingListener) {
        this.closeAfterEmpty = closeAfterEmpty;
        tabClosingListener = aTabClosingListener;
    }

    public CloseableTabbedPane addNewTab(String title, Component component) {

...
public class RoundedRectangle extends Shape {
    ...
    public void render(SampleGraphics graphics) {
        ...
        graphics.drawRoundRect(getEntity().getTransform().position.subt(scene.getView().getCamera().getPosition()), getSize().mul(getEntity().getTransform().scale), getColor(), isFilled(), (int) arc.x, (int) arc.y);
    }

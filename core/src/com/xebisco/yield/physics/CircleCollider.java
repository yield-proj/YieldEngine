...
public class CircleCollider extends Collider {
    ...
    public Shape getShape() {
        ...
        if(isIgnoreScaling())
            largerScale = 1;
        s.setRadius((float) (radius * largerScale / getApplication().physicsPpm()));
        s.m_p.set(Global.toVec2(center.divide(new Vector2D(getApplication().physicsPpm(), getApplication().physicsPpm()))));
        return s;
    }

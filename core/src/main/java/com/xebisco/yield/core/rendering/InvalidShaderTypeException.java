...
public class InvalidShaderTypeException extends Exception {
    private static final long serialVersionUID = 5309713184973289333L;
    ...
    public InvalidShaderTypeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
